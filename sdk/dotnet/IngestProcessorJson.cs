...
{
    public static class IngestProcessorJson
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<IngestProcessorJsonResult> InvokeAsync(IngestProcessorJsonArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<IngestProcessorJsonResult>("elasticstack:index/ingestProcessorJson:IngestProcessorJson", args ?? new IngestProcessorJsonArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<IngestProcessorJsonResult> Invoke(IngestProcessorJsonInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<IngestProcessorJsonResult>("elasticstack:index/ingestProcessorJson:IngestProcessorJson", args ?? new IngestProcessorJsonInvokeArgs(), options.WithDefaults());
    }


    public sealed class IngestProcessorJsonArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public IngestProcessorJsonArgs()
        {
        }
        public static new IngestProcessorJsonArgs Empty => new IngestProcessorJsonArgs();
    }

    public sealed class IngestProcessorJsonInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Flag that forces the parsed JSON to be added at the top level of the document. `target_field` must not be set when this option is chosen.
        /// </summary>
        ...
        public IngestProcessorJsonInvokeArgs()
        {
        }
        public static new IngestProcessorJsonInvokeArgs Empty => new IngestProcessorJsonInvokeArgs();
    }


    [OutputType]
    public sealed class IngestProcessorJsonResult
    {
        /// <summary>
        /// Flag that forces the parsed JSON to be added at the top level of the document. `target_field` must not be set when this option is chosen.
        /// </summary>
        ...
        [OutputConstructor]
        private IngestProcessorJsonResult(
            bool? addToRoot,
