...
{
    public static class IngestProcessorUserAgent
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<IngestProcessorUserAgentResult> InvokeAsync(IngestProcessorUserAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<IngestProcessorUserAgentResult>("elasticstack:index/ingestProcessorUserAgent:IngestProcessorUserAgent", args ?? new IngestProcessorUserAgentArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<IngestProcessorUserAgentResult> Invoke(IngestProcessorUserAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<IngestProcessorUserAgentResult>("elasticstack:index/ingestProcessorUserAgent:IngestProcessorUserAgent", args ?? new IngestProcessorUserAgentInvokeArgs(), options.WithDefaults());
    }


    public sealed class IngestProcessorUserAgentArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public IngestProcessorUserAgentArgs()
        {
        }
        public static new IngestProcessorUserAgentArgs Empty => new IngestProcessorUserAgentArgs();
    }

    public sealed class IngestProcessorUserAgentInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Extracts device type from the user agent string on a best-effort basis. Supported only starting from Elasticsearch version **8.0**
        /// </summary>
        ...
        public IngestProcessorUserAgentInvokeArgs()
        {
        }
        public static new IngestProcessorUserAgentInvokeArgs Empty => new IngestProcessorUserAgentInvokeArgs();
    }


    [OutputType]
    public sealed class IngestProcessorUserAgentResult
    {
        /// <summary>
        /// Extracts device type from the user agent string on a best-effort basis. Supported only starting from Elasticsearch version **8.0**
        /// </summary>
        ...
        [OutputConstructor]
        private IngestProcessorUserAgentResult(
