...
{
    public static class IngestProcessorSet
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<IngestProcessorSetResult> InvokeAsync(IngestProcessorSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<IngestProcessorSetResult>("elasticstack:index/ingestProcessorSet:IngestProcessorSet", args ?? new IngestProcessorSetArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<IngestProcessorSetResult> Invoke(IngestProcessorSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<IngestProcessorSetResult>("elasticstack:index/ingestProcessorSet:IngestProcessorSet", args ?? new IngestProcessorSetInvokeArgs(), options.WithDefaults());
    }


    public sealed class IngestProcessorSetArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public IngestProcessorSetArgs()
        {
        }
        public static new IngestProcessorSetArgs Empty => new IngestProcessorSetArgs();
    }

    public sealed class IngestProcessorSetInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The origin field which will be copied to `field`, cannot set `value` simultaneously.
        /// </summary>
        ...
        public IngestProcessorSetInvokeArgs()
        {
        }
        public static new IngestProcessorSetInvokeArgs Empty => new IngestProcessorSetInvokeArgs();
    }


    [OutputType]
    public sealed class IngestProcessorSetResult
    {
        /// <summary>
        /// The origin field which will be copied to `field`, cannot set `value` simultaneously.
        /// </summary>
        ...
        [OutputConstructor]
        private IngestProcessorSetResult(
            string? copyFrom,
