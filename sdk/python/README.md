...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `elasticstack` with the `NAME` of your provider.
...
- binary: pulumi-resource-elasticstack
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-elasticstack/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-elasticstack_darwin_amd64_v1
│   └── pulumi-resource-elasticstack
├── pulumi-elasticstack_darwin_arm64
│   └── pulumi-resource-elasticstack
├── pulumi-elasticstack_linux_amd64_v1
│   └── pulumi-resource-elasticstack
├── pulumi-elasticstack_linux_arm64
│   └── pulumi-resource-elasticstack
├── pulumi-elasticstack_windows_amd64_v1
│   └── pulumi-resource-elasticstack.exe
└── pulumi-elasticstack_windows_arm64
    └── pulumi-resource-elasticstack.exe
```
