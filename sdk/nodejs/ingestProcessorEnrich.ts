 ...
 * ```
 */
export function ingestProcessorEnrich(args: IngestProcessorEnrichArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorEnrichResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorEnrich:IngestProcessorEnrich", {
 ...
 */
export interface IngestProcessorEnrichArgs {
    /**
 ...
 */
export interface IngestProcessorEnrichResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorEnrichOutput(args: IngestProcessorEnrichOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorEnrichResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorEnrich(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorEnrich.
 */
export interface IngestProcessorEnrichOutputArgs {
    /**
     * Description of the processor.
     */
