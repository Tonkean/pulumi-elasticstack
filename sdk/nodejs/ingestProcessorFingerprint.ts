 ...
 * ```
 */
export function ingestProcessorFingerprint(args: IngestProcessorFingerprintArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorFingerprintResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorFingerprint:IngestProcessorFingerprint", {
 ...
 */
export interface IngestProcessorFingerprintArgs {
    /**
 ...
 */
export interface IngestProcessorFingerprintResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorFingerprintOutput(args: IngestProcessorFingerprintOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorFingerprintResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorFingerprint(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorFingerprint.
 */
export interface IngestProcessorFingerprintOutputArgs {
    /**
     * Description of the processor.
     */
