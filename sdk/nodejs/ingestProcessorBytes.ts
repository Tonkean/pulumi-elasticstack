 ...
 * ```
 */
export function ingestProcessorBytes(args: IngestProcessorBytesArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorBytesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorBytes:IngestProcessorBytes", {
 ...
 */
export interface IngestProcessorBytesArgs {
    /**
 ...
 */
export interface IngestProcessorBytesResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorBytesOutput(args: IngestProcessorBytesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorBytesResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorBytes(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorBytes.
 */
export interface IngestProcessorBytesOutputArgs {
    /**
     * Description of the processor.
     */
