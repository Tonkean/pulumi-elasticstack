 ...
 * ```
 */
export function ingestProcessorCircle(args: IngestProcessorCircleArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorCircleResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorCircle:IngestProcessorCircle", {
 ...
 */
export interface IngestProcessorCircleArgs {
    /**
 ...
 */
export interface IngestProcessorCircleResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorCircleOutput(args: IngestProcessorCircleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorCircleResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorCircle(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorCircle.
 */
export interface IngestProcessorCircleOutputArgs {
    /**
     * Description of the processor.
     */
