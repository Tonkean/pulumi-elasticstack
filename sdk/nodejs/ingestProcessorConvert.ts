 ...
 * ```
 */
export function ingestProcessorConvert(args: IngestProcessorConvertArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorConvertResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorConvert:IngestProcessorConvert", {
 ...
 */
export interface IngestProcessorConvertArgs {
    /**
 ...
 */
export interface IngestProcessorConvertResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorConvertOutput(args: IngestProcessorConvertOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorConvertResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorConvert(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorConvert.
 */
export interface IngestProcessorConvertOutputArgs {
    /**
     * Description of the processor.
     */
