 ...
 * ```
 */
export function ingestProcessorKv(args: IngestProcessorKvArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorKvResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorKv:IngestProcessorKv", {
 ...
 */
export interface IngestProcessorKvArgs {
    /**
 ...
 */
export interface IngestProcessorKvResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorKvOutput(args: IngestProcessorKvOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorKvResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorKv(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorKv.
 */
export interface IngestProcessorKvOutputArgs {
    /**
     * Description of the processor.
     */
