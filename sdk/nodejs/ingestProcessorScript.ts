 ...
 */
export function ingestProcessorScript(args?: IngestProcessorScriptArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorScriptResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorScript:IngestProcessorScript", {
 ...
 */
export interface IngestProcessorScriptArgs {
    /**
 ...
 */
export interface IngestProcessorScriptResult {
    /**
     * Description of the processor.
     */
 ...
 * See: https://www.elastic.co/guide/en/elasticsearch/reference/current/script-processor.html
 */
export function ingestProcessorScriptOutput(args?: IngestProcessorScriptOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorScriptResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorScript(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorScript.
 */
export interface IngestProcessorScriptOutputArgs {
    /**
     * Description of the processor.
     */
