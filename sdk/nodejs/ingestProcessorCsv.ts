 ...
 */
export function ingestProcessorCsv(args: IngestProcessorCsvArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorCsvResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorCsv:IngestProcessorCsv", {
 ...
 */
export interface IngestProcessorCsvArgs {
    /**
 ...
 */
export interface IngestProcessorCsvResult {
    /**
     * Description of the processor.
     */
 ...
 * If the `trim` option is enabled then any whitespace in the beginning and in the end of each unquoted field will be trimmed. For example with configuration above, a value of A, B will result in field field2 having value {nbsp}B (with space at the beginning). If trim is enabled A, B will result in field field2 having value B (no whitespace). Quoted fields will be left untouched.
 */
export function ingestProcessorCsvOutput(args: IngestProcessorCsvOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorCsvResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorCsv(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorCsv.
 */
export interface IngestProcessorCsvOutputArgs {
    /**
     * Description of the processor.
     */
