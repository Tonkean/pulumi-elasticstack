 ...
 * ```
 */
export function ingestProcessorRegisteredDomain(args: IngestProcessorRegisteredDomainArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorRegisteredDomainResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorRegisteredDomain:IngestProcessorRegisteredDomain", {
 ...
 */
export interface IngestProcessorRegisteredDomainArgs {
    /**
 ...
 */
export interface IngestProcessorRegisteredDomainResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorRegisteredDomainOutput(args: IngestProcessorRegisteredDomainOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorRegisteredDomainResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorRegisteredDomain(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorRegisteredDomain.
 */
export interface IngestProcessorRegisteredDomainOutputArgs {
    /**
     * Description of the processor.
     */
