 ...
 * ```
 */
export function ingestProcessorGrok(args: IngestProcessorGrokArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorGrokResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorGrok:IngestProcessorGrok", {
 ...
 */
export interface IngestProcessorGrokArgs {
    /**
 ...
 */
export interface IngestProcessorGrokResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorGrokOutput(args: IngestProcessorGrokOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorGrokResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorGrok(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorGrok.
 */
export interface IngestProcessorGrokOutputArgs {
    /**
     * Description of the processor.
     */
