 ...
 * ```
 */
export function ingestProcessorGeoip(args: IngestProcessorGeoipArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorGeoipResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorGeoip:IngestProcessorGeoip", {
 ...
 */
export interface IngestProcessorGeoipArgs {
    /**
 ...
 */
export interface IngestProcessorGeoipResult {
    /**
     * The database filename referring to a database the module ships with (GeoLite2-City.mmdb, GeoLite2-Country.mmdb, or GeoLite2-ASN.mmdb) or a custom database in the `ingest-geoip` config directory.
     */
 ...
 * ```
 */
export function ingestProcessorGeoipOutput(args: IngestProcessorGeoipOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorGeoipResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorGeoip(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorGeoip.
 */
export interface IngestProcessorGeoipOutputArgs {
    /**
     * The database filename referring to a database the module ships with (GeoLite2-City.mmdb, GeoLite2-Country.mmdb, or GeoLite2-ASN.mmdb) or a custom database in the `ingest-geoip` config directory.
     */
