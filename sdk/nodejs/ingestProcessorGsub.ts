 ...
 * ```
 */
export function ingestProcessorGsub(args: IngestProcessorGsubArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorGsubResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorGsub:IngestProcessorGsub", {
 ...
 */
export interface IngestProcessorGsubArgs {
    /**
 ...
 */
export interface IngestProcessorGsubResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorGsubOutput(args: IngestProcessorGsubOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorGsubResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorGsub(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorGsub.
 */
export interface IngestProcessorGsubOutputArgs {
    /**
     * Description of the processor.
     */
