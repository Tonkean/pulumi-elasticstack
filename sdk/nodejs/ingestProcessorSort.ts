 ...
 * ```
 */
export function ingestProcessorSort(args: IngestProcessorSortArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorSortResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorSort:IngestProcessorSort", {
 ...
 */
export interface IngestProcessorSortArgs {
    /**
 ...
 */
export interface IngestProcessorSortResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorSortOutput(args: IngestProcessorSortOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorSortResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorSort(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorSort.
 */
export interface IngestProcessorSortOutputArgs {
    /**
     * Description of the processor.
     */
