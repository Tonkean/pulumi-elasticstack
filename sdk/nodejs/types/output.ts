...
export interface DataSecurityRoleApplication {
    application: string;
    privileges: string[];
    resources: string[];
}

export interface DataSecurityRoleElasticsearchConnection {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: string;
...
export interface DataSecurityRoleIndex {
    allowRestrictedIndices: boolean;
    fieldSecurities: outputs.DataSecurityRoleIndexFieldSecurity[];
    names: string[];
    privileges: string[];
    query: string;
}

export interface DataSecurityRoleIndexFieldSecurity {
    excepts: string[];
    grants: string[];
}

export interface DataSecurityRoleMappingElasticsearchConnection {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: string;
...
export interface DataSecurityUserElasticsearchConnection {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: string;
...
export interface DataSnapshotRepositoryAzure {
    basePath: string;
    chunkSize: string;
    client: string;
    compress: boolean;
...
export interface DataSnapshotRepositoryElasticsearchConnection {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: string;
...
export interface DataSnapshotRepositoryF {
    chunkSize: string;
    compress: boolean;
    location: string;
...
export interface DataSnapshotRepositoryGc {
    basePath: string;
    bucket: string;
    chunkSize: string;
    client: string;
...
export interface DataSnapshotRepositoryHdf {
    chunkSize: string;
    compress: boolean;
...
export interface DataSnapshotRepositoryS3 {
    basePath: string;
    bucket: string;
    bufferSize: string;
    cannedAcl: string;
...
export interface DataSnapshotRepositoryUrl {
    chunkSize: string;
    compress: boolean;
