...
export interface DataSecurityRoleElasticsearchConnectionArgs {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: pulumi.Input<string>;
...
export interface DataSecurityRoleMappingElasticsearchConnectionArgs {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: pulumi.Input<string>;
...
export interface DataSecurityUserElasticsearchConnectionArgs {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: pulumi.Input<string>;
...
export interface DataSnapshotRepositoryElasticsearchConnectionArgs {
    /**
     * API Key to use for authentication to Elasticsearch
     */
    apiKey?: pulumi.Input<string>;
