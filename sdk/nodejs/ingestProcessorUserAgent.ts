 ...
 * ```
 */
export function ingestProcessorUserAgent(args: IngestProcessorUserAgentArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorUserAgentResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorUserAgent:IngestProcessorUserAgent", {
 ...
 */
export interface IngestProcessorUserAgentArgs {
    /**
 ...
 */
export interface IngestProcessorUserAgentResult {
    /**
     * Extracts device type from the user agent string on a best-effort basis. Supported only starting from Elasticsearch version **8.0**
     */
 ...
 * ```
 */
export function ingestProcessorUserAgentOutput(args: IngestProcessorUserAgentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorUserAgentResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorUserAgent(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorUserAgent.
 */
export interface IngestProcessorUserAgentOutputArgs {
    /**
     * Extracts device type from the user agent string on a best-effort basis. Supported only starting from Elasticsearch version **8.0**
     */
