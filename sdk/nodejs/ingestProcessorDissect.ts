 ...
 * ```
 */
export function ingestProcessorDissect(args: IngestProcessorDissectArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorDissectResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorDissect:IngestProcessorDissect", {
 ...
 */
export interface IngestProcessorDissectArgs {
    /**
 ...
 */
export interface IngestProcessorDissectResult {
    /**
     * The character(s) that separate the appended fields.
     */
 ...
 * ```
 */
export function ingestProcessorDissectOutput(args: IngestProcessorDissectOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorDissectResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorDissect(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorDissect.
 */
export interface IngestProcessorDissectOutputArgs {
    /**
     * The character(s) that separate the appended fields.
     */
