 ...
 * ```
 */
export function ingestProcessorSplit(args: IngestProcessorSplitArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorSplitResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorSplit:IngestProcessorSplit", {
 ...
 */
export interface IngestProcessorSplitArgs {
    /**
 ...
 */
export interface IngestProcessorSplitResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorSplitOutput(args: IngestProcessorSplitOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorSplitResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorSplit(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorSplit.
 */
export interface IngestProcessorSplitOutputArgs {
    /**
     * Description of the processor.
     */
