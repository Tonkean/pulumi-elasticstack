 ...
 * ```
 */
export function ingestProcessorDotExpander(args: IngestProcessorDotExpanderArgs, opts?: pulumi.InvokeOptions): Promise<IngestProcessorDotExpanderResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("elasticstack:index/ingestProcessorDotExpander:IngestProcessorDotExpander", {
 ...
 */
export interface IngestProcessorDotExpanderArgs {
    /**
 ...
 */
export interface IngestProcessorDotExpanderResult {
    /**
     * Description of the processor.
     */
 ...
 * ```
 */
export function ingestProcessorDotExpanderOutput(args: IngestProcessorDotExpanderOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<IngestProcessorDotExpanderResult> {
    return pulumi.output(args).apply((a: any) => ingestProcessorDotExpander(a, opts))
}

/**
 * A collection of arguments for invoking IngestProcessorDotExpander.
 */
export interface IngestProcessorDotExpanderOutputArgs {
    /**
     * Description of the processor.
     */
